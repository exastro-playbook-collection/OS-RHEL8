...
target_filepath_list.append('/etc/anacrontab')
target_filepath_list.append('/etc/crontab')
...
target_filepath = path + '/file/etc/cron.d'
set_recursive_path(target_filepath, path_len)

result = {}
target_parameter_root_key = 'VAR_RH_cron'
