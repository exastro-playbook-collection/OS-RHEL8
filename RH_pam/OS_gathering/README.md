Ansible Role: OS-RHEL8/RH_pam/OS_gathering
=======================================================
# Description
本ロールは、RHEL8に関するパスワード設定についての情報の取得を行います。
...
| Path | Description | 
| ---- | ----------- | 
| `/etc/authselect/system-auth` | /etc/authselect/system-authファイル | 
| `/etc/authselect/password-auth` | /etc/authselect/password-authファイル | 
