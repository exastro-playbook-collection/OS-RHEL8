...
target_filepath_list.append('/etc/bashrc')
target_filepath_list.append('/etc/csh.cshrc')
target_filepath_list.append('/etc/csh.login')
...
result = {}
target_parameter_root_key = 'VAR_RH_profile'
