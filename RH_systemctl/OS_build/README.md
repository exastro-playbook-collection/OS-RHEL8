Ansible Role: OS-RHEL8/RH_systemctl/OS_build
=======================================================
# Description
本ロールは、RHEL8に関するシステムサービス起動制御についての情報の設定を行います。
...
OS-RHEL8/RH_systemctl/OS_gatheringロールを利用します。
...
- hosts: all
  gather_facts: true
  roles:
    - role: OS-RHEL8/RH_systemctl/OS_build
      VAR_RH_systemctl:
      - action: 'true'
        name: httpd.service
        status: disabled
...
- hosts: all
  gather_facts: true
  roles:
    - role: OS-RHEL8/RH_systemctl/OS_gathering
  strategy: free
~~~
